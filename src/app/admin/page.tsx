  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="w-60 bg-green-700 text-white min-h-screen">
        ...
        <nav className="mt-4">
          <Link href="/admin" className="block py-3 px-4 bg-green-800 border-l-4 border-white">
          ...
          <Link href="/admin/accommodations" className="block py-3 px-4 hover:bg-green-800 transition-colors">
            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link href="/admin/tourist-spots" className="block py-3 px-4 hover:bg-green-800 transition-colors">
            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link href="/admin/restaurants" className="block py-3 px-4 hover:bg-green-800 transition-colors">
            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link href="/admin/users" className="block py-3 px-4 hover:bg-green-800 transition-colors">
            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link href="/admin/reports" className="block py-3 px-4 hover:bg-green-800 transition-colors">
            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link href="/admin/barangay-reports" className="block py-3 px-4 hover:bg-green-800 transition-colors">
            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link href="/signout" className="block py-3 px-4 hover:bg-green-800 transition-colors">
            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="flex-1 bg-gray-100">
        <div className="p-6 bg-white border-b">
          <h1 className="text-xl text-gray-700">Manage tourism activities, content, users, and analytics</h1>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            ...
            <div className="bg-white rounded-lg shadow p-6 flex justify-between items-center">
              <div>
                ...
                <p className="text-yellow-500 text-sm mt-2">5 pending approval</p>
              </div>
