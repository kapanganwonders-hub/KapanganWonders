            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link href="/dashboard" className={linkClass('/dashboard')}><LayoutDashboard size={18}/>Overview</Link></li>
                  <li><Link href="/dashboard/profile" className={linkClass('/dashboard/profile')}><User size={18}/>Profile</Link></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link href="/dashboard/my-travels" className={linkClass('/dashboard/my-travels')}><Map size={18}/>My Travels</Link></li>
                  <li><Link href="/dashboard/places-visited" className={linkClass('/dashboard/places-visited')}><Map size={18}/>Places Visited</Link></li>
                  <li><Link href="/dashboard/schedule-visit" className={linkClass('/dashboard/schedule-visit')}><Calendar size={18}/>Schedule Visit</Link></li>
                </ul>
              </div>
