...
export function PasswordStrengthIndicator({
  ...
  useEffect(() => {
    if (onStrengthChange) onStrengthChange(level);
    ...
    <div className={cn("space-y-2", className)}>
      ...
      <div className="relative">
        <input
          ...
          className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm pr-10"
          {...inputProps}
        />
