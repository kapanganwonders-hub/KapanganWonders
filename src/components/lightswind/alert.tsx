  ...
  ({ 
    ...
    return (
      <div
        ...
        role="alert"
        className={cn(
          "relative w-full rounded-xl border shadow-lg",
          withIcon && "[&>svg]:absolute [&>svg]:left-5 [&>svg]:top-5 [&>svg]:text-foreground [&>svg]:h-6 [&>svg]:w-6",
          withIcon && "[&>svg~*]:pl-10 [&>svg+div]:translate-y-[-2px]",
      ...
      >
        ...
        {dismissible && (
          <button
            ...
            transition-opacity hover:opacity-100 hover:bg-foreground/10
