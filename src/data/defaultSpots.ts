...
export const defaultSpots: TouristSpot[] = [
   {
      ...
      entranceFees: {
        adults: { label: "Adults (18–59 years)", amount: 55 },
        children: { label: "Children (below 6 years)", amount: 0 },
        environmental: { label: "Environmental Fee", amount: 120 },
        kids: { label: "Kids (11–17 years)", amount: 35 },
        pwd: { label: "Persons with Disability (PWD)", amount: 45 },
        seniors: { label: "Seniors (60+ years)", amount: 45 },
        tourGuide: { label: "Tour Guide Fee (optional)", amount: 400 }
      },
